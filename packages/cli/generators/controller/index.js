...
module.exports = class ControllerGenerator extends ArtifactGenerator {
    ...
    return this.prompt([
      {
        ...
        choices: [ControllerGenerator.BASIC, ControllerGenerator.CRUD],
  ...
  scaffold() {
    ...
    switch (this.artifactInfo.controllerType) {
      case ControllerGenerator.CRUD:
        template = 'controller-crud-template.ts';
        break;
      default:
        break;
    }
